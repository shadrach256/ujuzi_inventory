        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header py-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="stat-icon" style="--stat-grad: linear-gradient(135deg,#0f766e,#14b8a6); --stat-glow: rgba(16,185,129,0.3); width: 46px; height: 46px;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                    </div>
                    <div>
                        <h3 class="h5 fw-bold mb-0">New Product</h3>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="form-control" placeholder="e.g. Wireless Mouse">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" required class="form-control" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="number" name="quantity" id="quantity" value="{{ old('quantity') }}" required class="form-control" placeholder="0">
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <label for="image" class="file-drop d-block w-100">
                                ...
                                <div class="file-title">Click to upload an image</div>
                                <div class="file-sub">JPG, PNG, GIF, WEBP · Max 2MB</div>
                            </label>
